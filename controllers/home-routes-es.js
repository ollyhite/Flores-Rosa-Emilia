  ...
  try {
    ...
    for (let element of dbBouquetData.products) {
      ...
      bouquets.push({
        ...
        product_name_es: element.product_name_es,
        product_desc_es: element.product_desc_es,
        price: element.price,
        img_path: z,
      });
    }
    // console.log(bouquets);
    res.render("bouquets-es", {
      bouquets,
